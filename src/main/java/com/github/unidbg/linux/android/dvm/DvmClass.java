...
public class DvmClass extends DvmObject<String> implements Hashable {
    ...
    public void AddMethodMap(String name, String args) {
        staticMethodMap.put(name.hashCode() & 0xffffffffL, new DvmMethod(this, name, args, false));

    }

    public void AddStaticMethodMap(String name, String args) {
        //new DvmMethod(this, methodName, args, false)
        staticMethodMap.put(name.hashCode() & 0xffffffffL, new DvmMethod(this, name, args, true));
    }
}
